...
const RULES_GIRO_DOBLE_RECHAZO = {
  ...
  // 6) si evalúa en 35s, trabaja en 3 movimientos: recorrido al nivel + rechazo + respuesta débil.
    ...
    matches.push({
      ...
      meta: {
        ...
        status: seq.partial35
          ? "35s: 3 movimientos: recorrido al nivel + rechazo + respuesta débil"
          : "recorrido moderado hasta nivel + pérdida de fuerza + rechazo + respuesta débil + segundo rechazo",
        logic: seq.partial35
          ? (isResistance
              ? "35s: 1) compradores recorren hasta resistencia; 2) vendedores rechazan; 3) compradores responden débil => PUT"
              : "35s: 1) vendedores recorren hasta soporte; 2) compradores rechazan; 3) vendedores responden débil => CALL")
          : (isResistance
