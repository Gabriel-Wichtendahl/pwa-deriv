...
const RULES_GIRO_DOBLE_RECHAZO = {
  ...
  zoneMult: 1.75,
  zoneRangeMult: 0.24,
  minApproachRatio: 0.30,
  minOpenToLevelRatio: 0.42,
  minFirstAttackMs: 10000,
  maxFirstAttackMsRatio: 0.82,
  minRouteBodyRatio: 0.56,
  maxRouteIrregularity: 2.55,
  minRejectRatio: 0.090,
  minFirstRejectRatio: 0.110,
  minSecondRejectRatio: 0.050,
  minOppositeAdvanceRatio: 0.060,
  maxCloseBeyondTol: 0.38,
  maxDominantResponseRatio: 0.58,
  maxDominantResponseSlopeVsReject: 0.66,
  veryWeakDominantResponseRatio: 0.42,
  minDominantRetestRatio: 0.045,
  maxSecondAttemptBreakTol: 0.38,
  minClusterGap: 1,
  minClusterSize: 1,
  approachIrregularityMin: 1.12,
  weakAngleRatio: 0.78,
  minRejectionSlopeVsApproach: 1.05,
  minSecondRejectSlopeVsResponse: 0.98,
  allowOneTouchOnlyIfStrongIntracandle: true,
  oneTouchMinFirstRejectRatio: 0.140,
  oneTouchMaxResponseRatio: 0.52,
  oneTouchMinApproachRatio: 0.36,
};
