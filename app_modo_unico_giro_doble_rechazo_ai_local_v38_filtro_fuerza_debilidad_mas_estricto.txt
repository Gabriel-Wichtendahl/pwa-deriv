  ...
  return {
    ...
    meta: {
      ...
      status: seq.partial35
        ? "35s estricto: ataque amplio + rechazo fuerte + retesteo realmente débil"
        : "zona intravela estricta + ataque amplio + rechazo fuerte + retesteo débil + continuación contraria",
